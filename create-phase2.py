...
# Create directories
os.makedirs("src/app/exams", exist_ok=True)
os.makedirs("src/app/exam", exist_ok=True)
os.makedirs("src/app/exam/[slug]", exist_ok=True)

# 1. Create the /exams Discovery Page
exams_page = """
...
print("Created /exams directory page.")
