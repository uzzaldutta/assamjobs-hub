...
os.makedirs("src/app/admin/studio", exist_ok=True)
os.makedirs("src/app/admin/studio/questions", exist_ok=True)
os.makedirs("src/app/admin/studio/questions/import", exist_ok=True)
os.makedirs("src/app/admin/studio/materials", exist_ok=True)
os.makedirs("src/app/admin/studio/mock-tests", exist_ok=True)
os.makedirs("src/app/admin/studio/review", exist_ok=True)
